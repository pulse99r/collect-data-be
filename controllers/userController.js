...
userController.post('/', async (req, res) => {
  const {fname, lname, city, website, created_at} = req.body
  // const id = req.params.id
  
  try {
    const newUser = await db.one('INSERT INTO users03 (fname, lname, city, website, created_at) VALUES ($1, $2, $3, $4, $5) RETURNING *', [fname, lname, city, website, created_at]);
